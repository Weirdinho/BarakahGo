...
// @route   POST /api/auth/register (creates an unverified account, emails a verify link)
...
// @route   POST /api/auth/verify-email (confirms the emailed token, marks the account verified)
router.post('/verify-email', authController.verifyEmail);

// @route   POST /api/auth/resend-verification (sends a fresh verification link)
