  ...
  return (
    <>
      ...
      <div className="page-content">
        ...
        <p>
          Amanah and Ikhlas Charitable Initiative partners with corporations, NGOs, government agencies, and 
        ...
        <div className="partner-type">
          ...
          <p>
            Integrate Amanah and Ikhlas Charitable Initiative into social welfare programs for transparent, 
        ...
        <div className="contact-box">
          ...
          <p>
            Reach out to our partnerships team at <strong>partnerships@Amanah and Ikhlas Charitable Initiative.com</strong>
          </p>
        </div>
      </div>
    </>
