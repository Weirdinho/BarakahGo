...
const About = () => {
  ...
  border: 3px solid #ddd;
      ...
      <section className="page-hero">
        <h1>About Amanah Charity Foundation</h1>
      ...
      <div className="page-content">
        <h2>Our Story</h2>
        <p>
          Amanah Charity Foundation was founded with a simple belief: everyone deserves access to help when they need it most. 
