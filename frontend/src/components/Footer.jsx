      ...
      <footer className="footer">
        <div className="footer-inner">
          <div className="footer-brand">
            <h3>Amanah Charitable and Ikhlas Initiative</h3>
            <p>
          ...
          <div className="footer-links">
            <h4>About Us</h4>
            <ul>
              <li><Link to="/about">Amanah Charitable and Ikhlas Initiative-Smart Giving</Link></li>
        ...
        <div className="footer-bottom">
          <p>© 2026 Amanah Charitable and Ikhlas Initiative. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
